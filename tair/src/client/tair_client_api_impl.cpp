 ...
 *
 *
 * Version: $Id: tair_client_api_impl.cpp 1797 2013-08-26 09:40:50Z dutor $
 *
 * Authors:
...
FAIL_1:
      ...
      TAIRCALLBACKFUNC pfunc,void * parg )
  {
    ...
    packet->key = key;
    // set fill cache flag
    packet->key.data_meta.flag |= fill_cache ? TAIR_CLIENT_PUT_PUT_CACHE_FLAG
    : TAIR_CLIENT_PUT_SKIP_CACHE_FLAG;
    packet->data = data;
