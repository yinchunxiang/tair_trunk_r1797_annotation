 ...
 *
 * Version: $Id: define.hpp 1725 2013-08-02 09:59:21Z fengmao $
 *
 * Authors:
...
enum {
   ...
   TAIR_RETURN_DATA_EXPIRED = -3998,  //obsolete: use TAIR_RETURN_DATA_NOT_EXIST instead
...
typedef enum {
  ...
  TAIR_SERVER_CMD_MIGRATE_BUCKET,
  TAIR_SERVER_CMD_UNLOAD_BACKUPED_DB,
