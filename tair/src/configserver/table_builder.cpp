 ...
 *
 * Version: $Id: table_builder.cpp 1508 2013-04-26 06:41:40Z zongdai $
 *
 * Authors:
...
namespace tair {
  namespace config_server {
    ...
    void table_builder::build_index(const map<server_id_type,  int>&collector, 
		map<int, server_list_type> &indexer)
    {
