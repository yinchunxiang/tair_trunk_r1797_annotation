 ...
 *
 * Version: $Id: duplicate_manager.cpp 1245 2012-11-21 10:54:22Z nayan@taobao.com $
 *
 * Authors:
...
namespace tair{
   ...
   int duplicate_sender_manager::duplicate_data(
   		int area, const data_entry* key, const data_entry* value, int expire_time,
        int bucket_number, const vector<uint64_t>& des_server_ids, base_packet *, int)
   {
      ...
      bucket_waiting_queue::request_duplicate_packet 
	  	tmp_packet(new bucket_waiting_queue::request_duplicate_ptr());
