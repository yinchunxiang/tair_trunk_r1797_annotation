 ...
 *
 *
 * Version: $Id: duplicate_manager.hpp 1245 2012-11-21 10:54:22Z nayan@taobao.com $
 *
 * Authors:
...
namespace tair {
   ...
   private:
	  ...
	  // will set this to 0 when receive the response
      map<uint64_t, int64_t> last_send_time;  
      duplicate_sender_manager* psm;
      atomic_t packet_id_creater;

   };
   class duplicate_sender_manager : public base_duplicator, 
   	public tbsys::CDefaultRunnable, public tbnet::IPacketHandler {
   public:
