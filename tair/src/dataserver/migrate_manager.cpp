 ...
 *
 * Version: $Id: migrate_manager.cpp 1507 2013-04-26 06:41:15Z zongdai $
 *
 * Authors:
...
namespace tair {
   ...
   migrate_manager::migrate_manager(tbnet::Transport *transport, tair_packet_streamer *streamer, 
   	base_duplicator *this_duplicator, tair_manager *tair_mgr, 
