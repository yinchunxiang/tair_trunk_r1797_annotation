 ...
 *
 * Version: $Id: tair_manager.cpp 1520 2013-05-08 09:18:01Z yuming $
 *
 * Authors:
...
#include "remote_sync_manager.hpp"
  ...
  namespace tair {
    ...
    int tair_manager::put(int area, data_entry &key, data_entry &value, 
		int expire_time,base_packet *request,int heart_vesion)
    {
