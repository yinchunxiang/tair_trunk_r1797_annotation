 ...
 *
 *  Tool: pick sstable by specified buckets,
 *        output filenumber rename file and manifest of picked sstable
 *
 * Version: $Id: ldb_sst_picker.cpp 1311 2013-01-23 05:24:56Z nayan $
 *
 * Authors:
...
{
  fprintf(stderr, "%s: pick sstable by specified buckets, output filenumber rename file and manifest of picked sstable.\n"
